...
- 메서드
  - 요청: `access-control-request-methods`
  - 서버: `access-control-allow-methods`
- 헤더
  - 요청: `access-control-request-headers`
  - 서버: `access-control-allow-headers`
- 캐시
  - 서버: `access-control-max-age`

## 참고 자료

- [교차 출처 리소스 공유 (CORS)](https://developer.mozilla.org/ko/docs/Web/HTTP/CORS)
- [동일 출처 정책](https://developer.mozilla.org/ko/docs/Web/Security/Same-origin_policy)
- [서버 자원을 보호하기 위한 서버와 브라우져 간의 약속, CORS](https://www.youtube.com/watch?v=zA_YAuwPrcA)
